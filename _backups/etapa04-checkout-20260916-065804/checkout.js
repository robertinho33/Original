...
function normalizePhoneDigits(value) {
    ...
    // Remove o c�digo do pa�s do Brasil
    // somente quando houver 13 d�gitos.
    if (
        digits.length === 13 &&
...
async function handleSubmit(event) {
    ...
    try {
         ...
         * grava��o do pedido no Firestore.
         *
         * Assim o pedido � salvo somente uma vez.
         */
        if (order.payment.method === 'pix') {
            ...
            try {
                ...
                throw new Error(
                    ...
                    'O pedido n�o foi registrado. Tente novamente.'
                );
            }
        }

        /*
         * �NICA grava��o do pedido.
         *
         * No caso do PIX, o objeto j� cont�m:
         * - pixCode
         * - pixGeneratedAt
         * - PIX_GENERATED
         */
